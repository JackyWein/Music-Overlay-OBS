...
const particleLeft = document.getElementById('particle-left');
const particleRight = document.getElementById('particle-right');
const flashOverlay = document.getElementById('flash-overlay');
const shockwaveWrapper = document.getElementById('shockwave-container');
